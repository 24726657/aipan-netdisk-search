...
export default defineNuxtConfig({
  ...
  app: {
    ...
    head: {
      ...
      meta: [
        ...
        { property: 'og:url', content: 'https://sjdh898.top/' },
  ...
  runtimeConfig: {
    ...
    corsAllowedOrigins: process.env.NUXT_CORS_ALLOWED_ORIGINS || process.env.CORS_ALLOWED_ORIGINS || 'https://sjdh898.top,https://sjdh898.top/',
    ...
    pansouApiUrls: process.env.NUXT_PANSOU_API_URLS || process.env.PANSOU_API_URLS || '',
    pansouAuthToken:
